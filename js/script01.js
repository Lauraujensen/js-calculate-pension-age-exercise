...
function calculatePension(){
    ...
    // Jeg har nu adgang til inputfeltet og resultatparagraffen.

    resultParagraphElem.textContent = '';
    // Jeg tømmer resultatfeltet. Dette sikrer, at gamle beskeder ikke bliver stående, hvis brugeren prøver igen.
...
if (birthdate < new Date("1955-06-30")) {
    ...
    if (retirementAge <= 66) {
        ...
        resultParagraphElem.textContent = `Du kan gå på pension, når du er ${retirementAge} år.`;
    }
